...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.comments>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    string type = Request["type"] as string;
    Html.Telerik().Grid<meridian.bewell.proto.comments>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_comments")
        .Delete("_Delete", "admin_comments")
        .Update("_Update", "admin_comments")
        .Insert("_Insert", "admin_comments") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_comments").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
