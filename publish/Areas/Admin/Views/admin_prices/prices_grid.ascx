...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.prices>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.bewell.proto.prices>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_prices") 
        .Delete("_Delete", "admin_prices")
        .Update("_Update", "admin_prices")
        .Insert("_Insert", "admin_prices") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_prices").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
