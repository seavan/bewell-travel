...
{
    public partial class resort_zones : BaseEntity, ILookupValueAspectProvider, ISeoMetadata, ISeoMetadataAspectProvider
    {
        public override Uri EntityUri()
        {
            string uri = string.Format("/resortzone/{0}/{1}/", id, title.TransliterateAndClear());
