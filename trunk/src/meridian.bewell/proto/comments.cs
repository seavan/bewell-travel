...
{
	[MetadataType(typeof(comments_meta))]	public partial class comments : admin.db.IDatabaseEntity
	{
		public comments()
		{
			cn_child_comments = new List<comments>();
		}
		private long m_id = 0;
		...
		{
			if(this.u_comments_accounts != null)
			{
				this.u_comments_accounts.RemoveComments(this);
			}
			if(this.cn_child_comments_comments != null)
			{
				this.cn_child_comments_comments.RemoveChildComments(this);
			}
		}
		...
		public DateTime create_date
		{
			...
			set
			{
				if(m_create_date != value)
				{
					...
					if(m_create_date.Year < 1800) m_create_date = DateTime.MinValue;
					mc_create_date = true;
					// call update worker thread;
				}
			}
		...
		private List<comments> cn_child_comments
		{
			get; set; 
		}
		[ScriptIgnore]
		public IEnumerable<comments> ChildComments
		{
			get { return cn_child_comments; }
		}
		public IEnumerable<comments> GetChildComments()
		{
			return cn_child_comments;
		}
		public comments AddChildComments(comments _item, bool _insertToStore = false)
		{
		...
		public comments RemoveChildComments(comments _item, bool _complete = false)
		{
			cn_child_comments.Remove(_item);
			if(_complete) Meridian.Default.commentsStore.Delete(_item);
			return _item;
		}
		private accounts u_comments_accounts
		{
			get; set; 
		}
		public accounts GetCommentsAccount()
		{
			return u_comments_accounts ;
		}
		private comments cn_child_comments_comments
		{
			get; set; 
		}
		public comments GetChildCommentsComment()
		{
			return cn_child_comments_comments ;
		}
	}
}
