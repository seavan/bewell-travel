...
{
	[MetadataType(typeof(resort_zones_meta))]	public partial class resort_zones : admin.db.IDatabaseEntity
	{
		public resort_zones()
		{
		}
		...
		{
			get { return "resort_zones"; }
		}
		/* metafile template 
		internal class resort_zones_meta
		{
