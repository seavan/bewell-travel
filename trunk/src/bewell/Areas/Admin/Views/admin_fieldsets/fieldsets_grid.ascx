...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.fieldsets>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.bewell.proto.fieldsets>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_fieldsets") 
        .Delete("_Delete", "admin_fieldsets")
        .Update("_Update", "admin_fieldsets")
        .Insert("_Insert", "admin_fieldsets") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_fieldsets").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
