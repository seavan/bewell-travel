...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.hotels>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.bewell.proto.hotels>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_hotels") 
        .Delete("_Delete", "admin_hotels")
        .Update("_Update", "admin_hotels")
        .Insert("_Insert", "admin_hotels") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_hotels").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
