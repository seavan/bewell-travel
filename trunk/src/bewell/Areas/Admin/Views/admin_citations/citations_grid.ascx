...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.citations>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.bewell.proto.citations>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_citations") 
        .Delete("_Delete", "admin_citations")
        .Update("_Update", "admin_citations")
        .Insert("_Insert", "admin_citations") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_citations").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
