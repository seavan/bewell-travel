...
<%
    ...
    Html.Telerik().Grid<meridian.bewell.proto.questions>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_questions") 
        .Delete("_Delete", "admin_questions")
        .Update("_Update", "admin_questions")
        .Insert("_Insert", "admin_questions") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.question);
 
                    c.Bound(col => col.id).Edit("admin/admin_questions").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
