...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<meridian.bewell.proto.countries>>" %>
<div style="padding-top: 30px; margin-top: 10px;  border-top: 1px dotted silver;" >
<%

    Html.Telerik().Grid<meridian.bewell.proto.countries>()
        .Name("t_meridian.bewellList")
        .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("_Select", "admin_countries") 
        .Delete("_Delete", "admin_countries")
        .Update("_Update", "admin_countries")
        .Insert("_Insert", "admin_countries") 
        )
            ...
            c =>
                {
                    ...
                    c.Bound(col => col.id).Edit("admin/admin_countries").Width(100);
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
